...
var reqarray=[	{name:'request',require:'request'},
	            ...
	            {name:'request_action_appli_indus',require:'./serveur_api/request_action_appli_indus'},
	            ...
	            {name:'dbmodel',require:'./dbmodel_indus'}
			];
...
var app = function(){
	...
	this.config= require('./config_app_indus.json');
