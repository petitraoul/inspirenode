...
var database = {"name" : "mydb_camping.db",
				"application" : "inspirecamping",
				"descriptif" : "Base de donnée inspireatcamp",
				"menus": [{"id" : "box", "titre" : "Boxs", "action" : "box", "image" : "../images/zcarte-8-relais-ethernet-ip-ipx800-v3.jpg"},
			               ...
			               {"id" : "taches", "titre" : "Taches pour personnel", "action" : "taches", "image" : "../images/room_organizer.png"},
			               {"id" : "taches_etat", "titre" : "Etat taches", "action" : "taches_etat", "image" : "../images/room_organizer.png"},
			               {"id" : "taches_type", "titre" : "Type taches", "action" : "taches_type", "image" : "../images/room_organizer.png"},
			               {"id" : "questions", "titre" : "Questions (enquete)", "action" : "questions", "image" : "../images/favoris_icone_enable.png"},
			               {"id" : "liste_inventaire", "titre" : "Listes inventaires", "action" : "liste_inventaire", "image" : "../images/room_dining.png"},
			               {"id" : "objets_inventaire", "titre" : "Objets des listes inventaires", "action" : "objets_inventaire", "image" : "../images/room_child.png"},
			               ...
			               {"id" : "pub", "titre" : "Pubs video", "action" : "pubs", "image" : "../images/video.png"},
				...
				"tables": [
					...
					{"name": "tag", "in_database":true,
						"colonnes" : [
						              ...
						              {"name" : "gestionnaire" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "avec_animaux" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "classement" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "debut_periode" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "fin_periode" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "amenagement" , "type" : "TEXT","formulaire" : "input"},
						              {"name" : "equipement" , "type" : "TEXT","formulaire" : "input"},
					...
					{"name": "utilisateurs","in_database":true,
						"colonnes": [
						             ...
						             {"name" : "idposte" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "acces_caisse" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "acces_menag_tech" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "idposte" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "telephone" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "type" , "type" : "TEXT","formulaire" : "select" , "object" : [{"id":"ADMIN","nom":"Administrateur"},
								                                                                                       {"id":"GERANT","nom":"Gérant"},
								                                                                                       {"id":"PERSONNEL","nom":"Personnel technique"},
								                                                                                       {"id":"VACANCIER","nom":"Vacancier"}]},
								     {"name" : "emplacement" , "type" : "TEXT","formulaire" : "select","linkobject" : "tag"}, 
								     {"name" : "premier_jour" , "type" : "TEXT","formulaire" : "input"},
								     {"name" : "dernier_jour" , "type" : "TEXT","formulaire" : "input"}
						             ],					
					"actionsreturnlist" : [{"name" : "Supprimer", "type" : "button", "action" : "index?type=maj&action=delete"},
					                       {"name" : "Annuler", "type" : "button", "action" : "index?type=maj&action=keep"},
					                       {"name" : "Enregistrer", "type" : "button", "action" : "index?type=maj&action=save"}
					...
					{"name": "taches","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "tag" , "type" : "TEXT","formulaire" : "select" , "linkobject" : "tag"},
						             {"name" : "vacancier" , "type" : "TEXT","formulaire" : "select" , "linkobject" : "utilisateurs"},
						             {"name" : "personnel" , "type" : "TEXT","formulaire" : "select" , "linkobject" : "utilisateurs"},
						             {"name" : "personnel_rang" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "type" , "type" : "TEXT","formulaire" : "select" , "linkobject" : "taches_type"/*"object" : [{"id":"INVENTAIRE","nom":"Inventaire d'arrivé"},
						                                                                                       {"id":"MENAGE","nom":"Rendez-vous ménage de fin de séjour"},
						                                                                                       {"id":"PROBLEME_TECHNIQUE","nom":"Probleme technique"}
						                                                                                       ]*/},
						             {"name" : "date_heure" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "etat" , "type" : "TEXT","formulaire" : "select" , "linkobject" : "taches_etat"/*"object" : [{"id":"DECLARE","nom":"Demande effectuée"},
						                                                                                       {"id":"ENCOURS","nom":"En cours"},
						                                                                                       {"id":"CLOS","nom":"Demande cloturée"}
						                                                                                       ]*/},
						             {"name" : "commentaire" , "type" : "TEXT","formulaire" : "textarea"},
						             {"name" : "cominterne" , "type" : "TEXT","formulaire" : "textarea"},
						             {"name" : "comexterne" , "type" : "TEXT","formulaire" : "textarea"}
						             ]	,					
					"actionsreturnlist" : [{"name" : "Supprimer", "type" : "button", "action" : "index?type=maj&action=delete"},
					                       {"name" : "Annuler", "type" : "button", "action" : "index?type=maj&action=keep"},
					                       {"name" : "Enregistrer", "type" : "button", "action" : "index?type=maj&action=save"}
					...
					{"name": "taches_etat","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "uuid" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom" , "type" : "TEXT","formulaire" : "input"}
						           ]	,					
					"actionsreturnlist" : [{"name" : "Supprimer", "type" : "button", "action" : "index?type=maj&action=delete"},
					                       {"name" : "Annuler", "type" : "button", "action" : "index?type=maj&action=keep"},
					...
					{"name": "taches_type","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "uuid" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom" , "type" : "TEXT","formulaire" : "input"}
					...
					{"name": "questions","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "rang" , "type" : "TEXT","formulaire" : "input" },
						             {"name" : "actif" , "type" : "TEXT","formulaire" : "select" , "object" : [{"id":"O","nom":"actif"},
						             																			{"id":"N","nom":"non actif"}]},
						             {"name" : "question_fr" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "question_en" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "question_it" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "question_es" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "question_de" , "type" : "TEXT","formulaire" : "input"}
						             ]	,					
					"actionsreturnlist" : [{"name" : "Supprimer", "type" : "button", "action" : "index?type=maj&action=delete"},
					                       {"name" : "Annuler", "type" : "button", "action" : "index?type=maj&action=keep"},
					                       {"name" : "Enregistrer", "type" : "button", "action" : "index?type=maj&action=save"}
					...
					{"name": "reponses","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "id_question" , "type" : "TEXT","formulaire" : "input" },
						             {"name" : "id_user" , "type" : "TEXT","formulaire" : "input" },
						             {"name" : "note" , "type" : "TEXT","formulaire" : "input" }
						             ]
					},
					{"name": "liste_inventaire","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "nom" , "type" : "TEXT","formulaire" : "input" }
						             ],					
					...
					{"name": "objets_inventaire","in_database":true,
						"colonnes": [
						             {"name" : "id" , "type" : " integer primary key autoincrement","formulaire" : "label"},
						             {"name" : "code_liste" , "type" : "TEXT","formulaire" : "select","linkobject" : "liste_inventaire"},
						             {"name" : "zone_objet" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "rang_objet" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom_objet_fr" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom_objet_en" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom_objet_it" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom_objet_es" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "nom_objet_de" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "quantite_objet" , "type" : "TEXT","formulaire" : "input"},
						             {"name" : "actif" , "type" : "TEXT","formulaire" : "select" , "object" : [{"id":"O","nom":"actif"},
						             																			{"id":"N","nom":"non actif"}]}
						             ]	,					
					"actionsreturnlist" : [{"name" : "Supprimer", "type" : "button", "action" : "index?type=maj&action=delete"},
