$(document).on("pageshow","#Indus_Batiment_Page",function(){ // When entering pagetwo
	
});
$(document).on("pagecreate","#Indus_Batiment_Page",function(){ // When entering pagetwo
...
function get_info_batiment(data){
	displayTagslistIndus(data,"#BatimentList1","#BatimentList2","#Indus_Batiment_Page");
