...
$(document).on("pagecreate","#Indus_GraphiqueDetail_Page",function(){ // When entering pagetwo
	setTheme();
	
});
$(document).on("pageshow","#Indus_Graphique_Page",function(){ // When entering pagetwo
...
function chargeHighchart(element,uuid){
    ...
    $.mobile.changePage( $("#Indus_GraphiqueDetail_Page"), { transition: "slide"});
    document.location.hash = "#Indus_GraphiqueDetail_Page";
