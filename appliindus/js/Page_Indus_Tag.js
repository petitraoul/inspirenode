...
$(document).on("pageshow","#Indus_Tag_Page",function(){ // When entering pagetwo
	getJsonObject(get_info_tags,'index.php?action=alltag&batiment='+batiment_clicked_indus+'&v='+version);

});
$(document).on("pagecreate","#Indus_Tag_Page",function(){ // When entering pagetwo
...
function chargeTagPageIndus(element,tag_id) {
    ...
    $.mobile.changePage( $("#Indus_Tag_Page"), { transition: "slide"});
    document.location.hash = "#Indus_Tag_Page";
};

function get_info_tags(data){
	displayTagslistIndus2(data,"#TagList1","#TagList2","#Indus_Tag_Page");
