...
function appliqueconsigne(forceprevious){
	...
	//calculconsigneencours=true;
		GLOBAL.req.mode.get_etat(function(err,mode){
			...
			logger('INFO',{msg:'-----recherche mode fait appliquepreviousconsigne',mode_actuel:mode_actuel},'automation_'+programmation_consigne.nom);
								...
								for (var c in peripheriques_chauffage) {
									...
									/*if (consigneaappliquer){
										if (t==peripheriques_chauffage[c].id &&
											...
											logger('INFO',{nom:programmation_consigne.nom,idp:programmation_consigne.id
...
function get_nextprevious_consigne(mode_id,callback){
	...
	GLOBAL.obj.app.db.sqlorder(sql,
			function(rows){
				...
				logger('INFO',{nom:programmation_consigne.nom,idp:programmation_consigne.id
					,msg:'--Calcul previous et next consigne--',res:consigne_tag},'automation_'+programmation_consigne.nom);
